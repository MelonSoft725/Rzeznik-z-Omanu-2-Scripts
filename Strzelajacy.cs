...
public class Strzelajacy : MonoBehaviour
{
    ...
    [SerializeField] private GameObject prostaker;
    ...
    public void OnCollisionEnter2D(Collision2D other)
    {
        ...
        else if (other.gameObject.CompareTag("bullet"))
        {
            ...
            if (hp <= 0)
            {
                ...
                if (randomNumber == 5)
                {
                    prostaker.SetActive(true);
                    Vector3 locn = transform.position;
                    prostaker.transform.position = locn;
                }
